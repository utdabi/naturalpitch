...
const templates = [
  {
    ...
    subject_line: "Quick thought on scaling your engineering team",
  },
  {
    persona: "Founder",
    ...
    subject_line: "Congrats on the raise — one growth idea",
  },
  {
  ...
  },
  {
    ...
    subject_line: "Idea for [Company]'s next milestone",
  },
  {
    persona: "Hiring Manager",
    selectPersona: "Hiring Manager",
...
const Templates = () => {
  ...
  const useTemplate = (template: (typeof templates)[0]) => {
    navigate("/", { state: { message: template.text, persona: template.selectPersona, subjectLine: template.subject_line || "" } });
  };
            ...
            <div>
              ...
              {t.subject_line && (
                <p className="text-xs text-muted-foreground mt-2">
                  <span className="font-medium">Subject:</span> {t.subject_line}
                </p>
              )}
            </div>
            <Button
